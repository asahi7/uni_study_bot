...
public class schedulerTest {
	...
	public void testLogic11(){
		String testInput =
						"Math: (Monday 00:00-01:00"+ "\n"
						+"Math: (Monday 01:00-02:00"+ "\n"
						+"Math: (Monday 02:00-03:00"+ "\n"
						+"Math: (Monday 03:00-04:00"+ "\n"
						+"Math: (Monday 04:00-05:00"+ "\n"
						+"Math: (Monday 05:00-06:00"+ "\n"
						+"Math: (Monday 06:00-07:00"+ "\n"
						+"Math: (Monday 07:00-08:00"+ "\n"
						+"Math: (Monday 08:00-09:00"+ "\n"
						+"Math: (Monday 09:00-10:00"+ "\n"
						+"Math: (Monday 10:00-11:00"+ "\n"
						;
		String testResult = "No schedule for these courses can be constructed. Delete or change a course"
				;
		String result = sc.doWork(testInput);
	...
	public void testLogic12(){
		String testInput =
						...
						+"Math: (Monday 08:00-09:00"+ "\n"
						+"Math: (Monday 09:00-10:00"+ "\n"
						+"Math: (Tuesday 01:00-02:00"+ "\n"
						+"Math: (Tuesday 02:00-03:00"+ "\n"
						+"Math: (Tuesday 03:00-04:00"+ "\n"
						+"Math: (Tuesday 04:00-05:00"+ "\n"
						+"Math: (Tuesday 05:00-06:00"+ "\n"
						+"Math: (Tuesday 06:00-07:00"+ "\n"
						+"Math: (Tuesday 07:00-08:00"+ "\n"
						+"Math: (Tuesday 08:00-09:00"+ "\n"
						+"Math: (Tuesday 09:00-10:00"+ "\n"
						;
		String testResult = "No schedule for these courses can be constructed. Delete or change a course"
				;
		String result = sc.doWork(testInput);
